...
struct PinppleWidget : ModuleWidget {
    PinppleWidget(Pinpple* module) {
        setModule(module);
        setPanel(createPanel(asset::plugin(pluginInstance, "Pinpple.png")));
        ...
        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(centerX + 15, 40), module, Pinpple::VOLUME_PARAM));

        addParam(createParamCentered<RoundBlackKnob>(Vec(centerX, 84), module, Pinpple::FREQ_PARAM));

        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(centerX - 15, 108), module, Pinpple::FREQ_CV_ATTEN_PARAM));
        addInput(createInputCentered<PJ301MPort>(Vec(centerX + 15, 108), module, Pinpple::FREQ_CV_INPUT));

        addParam(createParamCentered<RoundBlackKnob>(Vec(centerX, 155), module, Pinpple::RESONANCE_PARAM));

        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(centerX - 15, 179), module, Pinpple::RESONANCE_CV_ATTEN_PARAM));
        addInput(createInputCentered<PJ301MPort>(Vec(centerX + 15, 179), module, Pinpple::RESONANCE_CV_INPUT));

        addParam(createParamCentered<RoundBlackKnob>(Vec(centerX, 226), module, Pinpple::FM_AMOUNT_PARAM));

        addInput(createInputCentered<PJ301MPort>(Vec(centerX + 15, 265), module, Pinpple::FM_INPUT));
        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(centerX - 15, 265), module, Pinpple::NOISE_MIX_PARAM));
        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(centerX - 15, 292), module, Pinpple::FM_MOD_CV_ATTEN_PARAM));
