...
struct MADDYWidget : ModuleWidget {
    MADDYWidget(MADDY* module) {
        ...
        addOutput(createOutputCentered<PJ301MPort>(Vec(60, 52), module, MADDY::RESET_OUTPUT));
        
        addChild(createLightCentered<MediumLight<RedLight>>(Vec(72, 50), module, MADDY::MANUAL_RESET_LIGHT));
        addParam(createParamCentered<VCVButton>(Vec(72, 50), module, MADDY::MANUAL_RESET_PARAM));
        ...
        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(98, 308), module, MADDY::CLOCK_SOURCE_PARAM));
