...
SequenceTextField* textField = nullptr;
    ...
    SongModeWidget(SongMode* module) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            addParam(createParamCentered<RoundSmallBlackKnob>(Vec(50, y + 6), module, SongMode::LENGTH_1_PARAM + i));
        ...
        addParam(createParamCentered<RoundSmallBlackKnob>(Vec(50, 355), module, SongMode::FADE_TIME_PARAM));
